...
print("=" * 70)
print("FULL FOV INTEGRATION: Image Features + RNA Expression (Breast Cancer)")
print("=" * 70)
t_start = time.time()
...
# Precompute compartment boundary distance and intensity gradient ONCE
...
fig.suptitle('Breast — Multimodal PCA Leiden Clusters', fontsize=14, y=1.02)
plt.tight_layout()
...
ax.set_title('Breast — Leiden Clusters Spatial Map')
ax.set_xlabel('X (µm)')
ax.set_ylabel('Y (µm)')
ax.legend(markerscale=3, fontsize=8)
plt.tight_layout()
...
print(f"""
┌──────────────────────────────────────────────────────────────┐
│              FULL FOV INTEGRATION RESULTS (Breast)            │
├──────────────────────────────────────────────────────────────┤
│  Full FOV:             {w}×{h} px                              │
