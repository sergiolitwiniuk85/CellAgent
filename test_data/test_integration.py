...
# CONFIG
# ────────────────────────────────────────────────────────────────────────────
CROP_Y0, CROP_X0 = 1200, 2000     # Top-left of crop (pixels)
CROP_SIZE = 1200                    # Crop size (pixels) — larger than before
...
print("=" * 70)
print("INTEGRATION TEST: Image Features + RNA Expression")
print("=" * 70)
t_start = time.time()
